...
class SupermarketEnv:
    ...
    def _generate_mock_inventory(self, task_level: str) -> List[PerishableItem]:
        ...
        elif task_level in ["medium", "hard"]:
    ...
    def reset(self, task_level: str = "medium") -> RetailObservation:
        """Starts a new simulation month with a specific difficulty."""
        self.current_task = task_level # Save the current task level
        self.current_day = 1
        self.total_revenue = 0.0
        self.landfill_waste_count = 0
